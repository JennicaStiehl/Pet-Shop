...
ActiveRecord::Schema.define(version: 2019_03_27_025328) do
  ...
  create_table "shop_employees", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["employee_id"], name: "index_shop_employees_on_employee_id"
  ...
  add_foreign_key "shop_employees", "employees"
